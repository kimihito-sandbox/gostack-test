...
func (o GooseDBVersionTemplate) BuildSetter() *models.GooseDBVersionSetter {
	...
	if o.Tstamp != nil {
		val := o.Tstamp()
		m.Tstamp = omitnull.FromNull(val)
	}
...
func (m gooseDBVersionMods) ID(val int64) GooseDBVersionMod {
...
func (m gooseDBVersionMods) IDFunc(f func() int64) GooseDBVersionMod {
	return GooseDBVersionModFunc(func(_ context.Context, o *GooseDBVersionTemplate) {
		o.ID = f
	})
}
...
// Set the model columns to this value
func (m gooseDBVersionMods) IsApplied(val int64) GooseDBVersionMod {
	return GooseDBVersionModFunc(func(_ context.Context, o *GooseDBVersionTemplate) {
		o.IsApplied = func() int64 { return val }
	})
}

// Set the Column from the function
func (m gooseDBVersionMods) IsAppliedFunc(f func() int64) GooseDBVersionMod {
	return GooseDBVersionModFunc(func(_ context.Context, o *GooseDBVersionTemplate) {
		o.IsApplied = f
	})
}
...
func (m gooseDBVersionMods) RandomTstampNotNull(f *faker.Faker) GooseDBVersionMod {
	return GooseDBVersionModFunc(func(_ context.Context, o *GooseDBVersionTemplate) {
		o.Tstamp = func() null.Val[time.Time] {
			if f == nil {
				f = &defaultFaker
