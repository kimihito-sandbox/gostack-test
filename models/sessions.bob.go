...
type SessionSetter struct {
	...
	Expiry omit.Val[float64] `db:"expiry" `
}
...
func (o *Session) pkEQ() dialect.Expression {
	return sqlite.Quote("sessions", "token").EQ(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
func (o SessionSlice) pkIN() dialect.Expression {
	...
	return sqlite.Quote("sessions", "token").In(bob.ExpressionFunc(func(ctx context.Context, w io.StringWriter, d bob.Dialect, start int) ([]any, error) {
...
type sessionWhere[Q sqlite.Filterable] struct {
	...
	Expiry sqlite.WhereMod[Q, float64]
}
...
func buildSessionWhere[Q sqlite.Filterable](cols sessionColumns) sessionWhere[Q] {
	return sessionWhere[Q]{
		...
		Expiry: sqlite.Where[Q, float64](cols.Expiry),
	}
}
